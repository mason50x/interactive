...
/**
 * PixelBlast — vendored from React Bits (`src/ts-tailwind/Backgrounds/PixelBlast`),
 * https://github.com/DavidHDev/react-bits, MIT.
 *
 * Kept close to upstream so it can be re-pulled; the only edits are the
 * `"use client"` directive above and the named export at the foot of the file.
 * Wrapper and tuning live in the component that uses it.
 */
