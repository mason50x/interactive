  ...
  return (
    <PhilosophyPlayer>
      ...
      <div
        ...
        role="img"
        aria-label="A prohibition symbol, followed by a crossed-out phone, the word FUN, and the ChatGPT logo."
      >
        <div
          aria-hidden="true"
          data-philosophy-frame="phone"
          className={styles.slot}
        >
          <svg
            className={styles.phoneGlyph}
            viewBox="0 0 150 240"
            fill="none"
            stroke="currentColor"
            strokeWidth="8"
        ...
        <div
          aria-hidden="true"
          data-philosophy-frame="chatgpt"
          className={styles.slot}
        >
          {/* OpenAI mark: Simple Icons v13.21.0, CC0. */}
          <svg
            className={styles.chatgptGlyph}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
