...
test("only the four playtime sections are restricted, including deep links", () => {
  for (const path of ["/activities", "/activities/chess", "/entertainment", "/entertainment/show", "/experience", "/experience/app", "/learning-simulator", "/learning-simulator/html/hash", "/learning-simulator/published/id"]) {
