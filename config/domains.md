...
| Experience (Worker) | `EXPERIENCE_ORIGIN`, or `NEXT_PUBLIC_EXPERIENCE_ORIGIN` | none — `/browse` reports it | one variable, plus the `frame-ancestors` list in `experience/site/_headers` if the site moves |
